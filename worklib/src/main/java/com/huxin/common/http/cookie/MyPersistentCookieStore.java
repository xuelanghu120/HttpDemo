...
public class MyPersistentCookieStore {
    ...
    private final HashMap<String, Cookie> myCookiesMap;
    ...
    public Map<String, String> getCookieMap() {
        ...
        for (Map.Entry<String, Cookie> entity : myCookiesMap.entrySet()) {
            ...
            myCookiesStringMap.put(cookie.name(), cookie.value());
        }
    ...
    public boolean isOutTime() {
        if (myCookiesMap.size() > 0) {
            for (Map.Entry<String, Cookie> entity : myCookiesMap.entrySet()) {
                Cookie cookie = entity.getValue();
                Logger.d("LOG_TAGcookie", "System" + System.currentTimeMillis() + "");
                Logger.d("LOG_TAGcookie", "cookie" + cookie.expiresAt() + "");
     ...
     * 将字符串反序列化成cookies
     *
     * @param cookieString cookies stringReq
     ...
     * @return stringReq containing hex values
     */
     ...
     * 十六进制字符串转二进制数组
     *
     * @param hexString stringReq of hex-encoded values
