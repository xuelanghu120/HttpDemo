...
public class Constant {
    ...
    public static String PATH_DATA = FileUtils.createRootPath(Global.getContext()) + "/cache";

    public static String PATH_COLLECT = FileUtils.createRootPath(Global.getContext()) + "/collect";
    ...
    public static String BASE_PATH = Global.getContext().getCacheDir().getPath();
