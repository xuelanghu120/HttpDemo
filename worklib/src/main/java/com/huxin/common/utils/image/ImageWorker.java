...
public class ImageWorker {
    ...
    public static void imageLoader(Context context, ImageView view, String url, String localUrl) {
        if (!TextUtils.isEmpty(url)) {
            ...
            getUrl(entity)
                    .subscribe(new Consumer<ImageLoaderLoacalCacheEntity>() {
                        @Override
                        public void accept(ImageLoaderLoacalCacheEntity entity) {
    ...
    public static Flowable<ImageLoaderLoacalCacheEntity> getUrl(ImageLoaderLoacalCacheEntity entity) {
        return Flowable.just(entity)
                .subscribeOn(Schedulers.computation())
                .doOnNext(new Consumer<ImageLoaderLoacalCacheEntity>() {
                    @Override
                    public void accept(ImageLoaderLoacalCacheEntity entity) {
...
//                    .setDecodeFormat(DecodeFormat decodeFormat)
     ...
     * @param id
     */
    public static void loadLocalDrawble(Context context,ImageView imageView, int id) {
